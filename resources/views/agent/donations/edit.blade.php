        ...
        <form action="{{ route('agent.donations.update', $donation->id) }}" method="POST">
            ...
            <div class="row mb-3">
                ...
                <div class="col-md-4">
                    ...
                    <input type="number" step="0.1" name="temperature" id="temperature" class="form-control @error('temperature') is-invalid @enderror" value="{{ old('temperature', $donation->temperature) }}">
            ...
            <div class="mb-3">
                ...
                <textarea name="notes" id="notes" class="form-control">{{ old('notes', $donation->notes) }}</textarea>
            </div>
